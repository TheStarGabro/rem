...
content.Position = UDim2.fromScale(0,HOTBAR_HEIGHT)
content.Size = UDim2.fromScale(1,1-HOTBAR_HEIGHT)
content.Parent = ui
...
local function HotbarButton(icon)
	local button = Instance.new("ImageButton")
	button.Image = "rbxassetid://108710284607883"
